...
public class FinanceService {
  ...
  @Transactional
  public FinanceDto create(CreateAndUpdateFinanceDTO dto) {
  ...
  @Transactional
  public void recordExpense(FinanceCategory category, BigDecimal amount,
  ...
  @Transactional
  public FinanceDto update(Long id, CreateAndUpdateFinanceDTO dto) {
    Finance finance = financeRepository.findById(id)
      .orElseThrow(() -> new ResourceNotFoundException("Finance record not found with id: " + id));
