...
public class FinanceController {
  ...
  public FinanceDto create(@RequestBody CreateAndUpdateFinanceDTO dto) {
  ...
  @PutMapping("/{id}")
  @PreAuthorize("hasRole('manage-finances')")
  public FinanceDto update(@PathVariable Long id, @RequestBody CreateAndUpdateFinanceDTO dto) {
