...
public class HealthService {
  ...
  @Transactional
  public HealthRecordDto createRecord(CreateAndUpdateHealthRecordDto dto) {
    ...
    if (dto.getTreatmentId() != null) {
      ...
      record.setDosage(treatment.getDosage());
  ...
  @Transactional
  public HealthRecordDto updateRecord(Long id, CreateAndUpdateHealthRecordDto dto) {
    HealthRecord record = healthRecordRepository.findById(id)
      .orElseThrow(() -> new ResourceNotFoundException("Health record not found with id: " + id));
