...
public class HealthRecordController {
  ...
  public HealthRecordDto create(@RequestBody CreateAndUpdateHealthRecordDto dto) {
  ...
  @PutMapping("/{id}")
  @PreAuthorize("hasRole('manage-health')")
  public HealthRecordDto update(@PathVariable Long id, @RequestBody CreateAndUpdateHealthRecordDto dto) {
