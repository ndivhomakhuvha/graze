...
public class AnimalController {
  ...
  public AnimalDto register(@RequestBody CreateAndEditAnimalDTO createAndEditAnimalDTO) {
    return service.register(createAndEditAnimalDTO);
  }
  ...
  @PutMapping("/{tagNo}")
  @PreAuthorize("hasRole('manage-animal')")
  public AnimalDto update(@PathVariable String tagNo, @RequestBody CreateAndEditAnimalDTO createAndEditAnimalDTO) {
    return service.update(tagNo, createAndEditAnimalDTO);
  }
